...
(defn bfk-spawn "Process coll as a brainf**k machine, eval exp as a brainf**k expression on it, and then collect the outputs. Returns the outputs as a list/string" [coll exp] (:output (brainfk coll exp)))
